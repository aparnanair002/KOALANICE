                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                        ...
                                        <div class="mb-3 mb-sm-0">
                                            <h5 class="card-title fw-semibold">New Invites <i class="ti ti-user"></i></h5>
                                            <div id="inviteList">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                        ...
                                        <div class="mb-3 mb-sm-0">
                                            <h5 class="card-title fw-semibold">My Groups <i class="ti ti-heart"></i>
                                            </h5>
    ...
    <script>
        ...
        function loadRequested() {
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $('#inviteList').html(response.html);

                    } else {
                        $('#inviteList').html('<p>No users found.</p>');

                    }
                },
                error: function() {
                    $('#inviteList').html('<p>Failed to load users.</p>');
                }
            });
        }
        ...
        function loadFriends() {
            $.ajax({
                ...
                error: function() {
                    $('#groupList').html('<p>Failed to load users.</p>');
                }
            });
        }
